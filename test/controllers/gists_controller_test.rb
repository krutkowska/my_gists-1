...
class GistsControllerTest < ActionController::TestCase
  ...
  test "should create gist" do
    assert_difference('Gist.count') do
      post :create, gist: { description: @gist.description, lexer: @gist.lexer, snippet: @gist.snippet }
    end
  ...
  test "should update gist" do
    patch :update, id: @gist, gist: { description: @gist.description, lexer: @gist.lexer, snippet: @gist.snippet }
    assert_redirected_to gist_path(assigns(:gist))
  end
